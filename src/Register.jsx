...
const Register = () => {
    ...
    return (
        ...
        <div className="bg-[#543c52]/50 border-[#edd2cb] rounded-2xl p-8 shadow-lg backdrop-blur-sm relative">
            ...
            <div className="relative my-7">
                <input type={confirmPasswordShown ? "text" : "password"} className="block w-80 py-2.3 px-0 text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:focus:border-[#f55951] focus:outline-none focus:ring-0 focus-text-white focus-border-[#f55951] peer" placeholder=""/>
