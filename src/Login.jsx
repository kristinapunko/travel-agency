            ...
            <div className="relative my-7">
                ...
                <div className="flex justify-between items-center">
                    ...
                    <input type="checkbox" name="" id=""/>
                        ...
                        <label className="text-sm md:text-base" htmlFor="Rememmber Me">Rememmber Me</label>
                    </div>
                    <Link to='' className="text-sm md:text-base">Forgot Password?</Link>
                </div>
                <button className="w-full mb-4 text-[18px] mt-4 md:mt-6 rounded-full bg-white text-[#543c52] hover:text-[#f55951] py-1 md:py-2 transition-colors duration-300" type="submit">Login</button>
                <div>
