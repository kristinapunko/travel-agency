    ...
    return (
        ...
        <div>
            <div className="bg-[#543c52]/50 border-[#edd2cb] rounded-2xl p-8 shadow-lg backdrop-blur-sm relative">
                <h1 className="text-xl text-white font-bold text-center mb-8">Залиште свій номер телефону, менеджер зв'яжеться з вами і підбере найкращий варіант туру в цей готель</h1>
                <form action="">
